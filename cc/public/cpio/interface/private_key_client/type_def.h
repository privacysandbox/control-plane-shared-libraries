...
struct PrivateKeyVendingEndpoint {
  /** @brief The region of KMS. This should match the region of
   *  PrivateKeyVendingService and PublicKeyVendingService due to
   *  KeyVendingService's authentication mechanism.
   */
  KMSRegion kms_region;
  /// The key name used to create KmsAead.
...
struct PrivateKeyClientOptions {
  ...
  /** @brief The account idendity to access the cloud. This is used to create
