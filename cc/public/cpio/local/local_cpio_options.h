 ...
 */
#ifndef SCP_CPIO_LOCAL_CPIO_OPTIONS_H_
#define SCP_CPIO_LOCAL_CPIO_OPTIONS_H_
...
/// Global CPIO options to run CPIO locally.
struct LocalCpioOptions : public CpioOptions {
  /// Cloud region.
  std::string region;
  /// Environment name.
