...
DEFINE_ERROR_CODE(SC_CONFIG_CLIENT_PROVIDER_PARAMETER_NOT_FOUND,
                  SC_CONFIG_CLIENT_PROVIDER, 0x0003, "Parameter not found",
                  HttpStatusCode::BAD_REQUEST)
DEFINE_ERROR_CODE(SC_CONFIG_CLIENT_PROVIDER_INVALID_PARAMETER_NAME,
                  SC_CONFIG_CLIENT_PROVIDER, 0x0004,
