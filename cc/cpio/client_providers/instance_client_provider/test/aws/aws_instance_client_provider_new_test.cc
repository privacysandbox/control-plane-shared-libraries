...
#include "cpio/client_providers/instance_client_provider/src/aws/aws_instance_client_provider_new.h"
...
#include "cpio/client_providers/instance_client_provider/mock/aws/mock_ec2_client_new.h"
...
using google::scp::cpio::client_providers::mock::MockEC2ClientNew;
using std::atomic;
...
class AwsInstanceClientProviderTest : public TestWithParam<string> {
 protected:
  AwsInstanceClientProviderTest()
    ...
    ec2_client_ = make_shared<NiceMock<MockEC2ClientNew>>();
  ...
  shared_ptr<MockEC2ClientNew> ec2_client_;
