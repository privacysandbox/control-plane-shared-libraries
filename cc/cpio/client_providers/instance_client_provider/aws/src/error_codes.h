...
DEFINE_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_INVALID_TAG_NAME,
                  SC_AWS_INSTANCE_CLIENT_PROVIDER, 0x0002, "Invalid tag name",
...
DEFINE_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_TAG_VALUE_NOT_FOUND,
...
MAP_TO_PUBLIC_ERROR_CODE(SC_AWS_INSTANCE_CLIENT_PROVIDER_TAG_VALUE_NOT_FOUND,
