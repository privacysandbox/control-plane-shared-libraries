...
#include "cpio/client_providers/metric_client_provider/metric_utils/interface/timeseries_metric_interface.h"
...
class TimeSeriesMetric : public TimeSeriesMetricInterface {
 ...
 protected:
  /**
   * @brief Generates a RecordMetricsProtoRequest based on the input value and
